...
1. 下載通用安裝檔
   ...
   **最新穩定發行版本 DIME v.1.2.441（更新日期: 2026-02-21）**
   ...
   <!-- DOWNLOAD_START -->
   **最新開發版本 DIME v1.2.478 (更新日期: 2026-03-06)**
   <!-- DOWNLOAD_END --> 
...
3. **（建議）驗證檔案完整性：**
   ...
   **最新穩定發行版本 DIME v.1.2.441 SHA-256 CHECKSUM (更新日期: 2026-02-21):**
   ...
   <!-- CHECKSUM_START -->
   **最新開發版本 DIME v1.2.478 SHA-256 CHECKSUM (更新日期: 2026-03-06):**
   
   | 檔案 | SHA-256 CHECKSUM |
   |------|----------------|
   | DIME-Universal.exe | `071C86459C11C846D6E21AC4C999F6C8C412F7944367CD5E9E3B0E08D4A3C161` |
   | DIME-Universal.zip | `2D6DD80080538F0F0371AEE03CA42B601641D30CD7691EE48AEC7C3C691C2461` |
   <!-- CHECKSUM_END -->
